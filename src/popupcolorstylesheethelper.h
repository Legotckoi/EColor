...
public:
    ...
    static QString getStyleSheetOfLoupeButton(const bool isActive, const QColor &color);
    ...
    static QString getStyleSheetOfLoupeWidget(const QColor &color);
    ...
    static QString getStyleSheetOfLineEdit(const QColor &color);
    static QString getStyleSheetOfLoupeLabel();
